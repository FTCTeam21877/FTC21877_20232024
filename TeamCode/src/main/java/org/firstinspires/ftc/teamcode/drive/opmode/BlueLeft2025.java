...
@Autonomous(name = "BlueLeft2025", preselectTeleOp= "Tele op final")
@Disabled
public class BlueLeft2025 extends LinearOpMode {
    ...
    private void doTask() {
        ...
        TrajectorySequence goToBlock = drive.trajectorySequenceBuilder(dropTheSample.end())
                ...
                .lineToLinearHeading(new Pose2d(-42, 49, Math.toRadians(0)), setSpeed(20), setAccelatation())
        ...
        TrajectorySequence dropInto2ndBasket = drive.trajectorySequenceBuilder(goTo2ndBlock.end())
                .lineToLinearHeading(new Pose2d(-58, 55.5, Math.toRadians(0)), setSpeed(20), setAccelatation())
        ...
        TrajectorySequence dropInto3rdBasket = drive.trajectorySequenceBuilder(goTo3rdBlock.end())
                .lineToLinearHeading(new Pose2d(-57, 60, Math.toRadians(0)), setSpeed(20), setAccelatation())
                // .lineTo(new Vector2d(-57, 60), setSpeed(10), setAccelatation())
                .turn(Math.toRadians(-45))
                .addTemporalMarker(6, () -> {
                    moveWrist(20,1);
