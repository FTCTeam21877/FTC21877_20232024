...
@Autonomous(name = "RBBasketLeft2025", preselectTeleOp= "Tele op final")
public class RB2Left2025 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        startPose = new Pose2d(-65, 34, Math.toRadians(0));
    ...
    private void doTask() {
        ...
        sleep(500);
        TrajectorySequence dropIntoBasket1 = drive.trajectorySequenceBuilder(dropTheSample.end())
                ...
                .build();
        drive.followTrajectorySequence(dropIntoBasket1);


        //Go to block
        TrajectorySequence goToBlock = drive.trajectorySequenceBuilder(dropIntoBasket1.end())
