...
@Autonomous(name = "RB2Right2025" , preselectTeleOp= "Tele op final")
@Disabled
public class RB2Right2025 extends LinearOpMode {
...
//test
    ...
    private void doTask() {
        ...
        TrajectorySequence goToSpecimen = drive.trajectorySequenceBuilder(dropTheSample.end())
                ...
                .splineToLinearHeading(new Pose2d(-45, -39.5, Math.toRadians(180)),Math.toRadians(0), setSpeed(30), setAccelatation())
                //.turn(Math.toRadians(-90))
                .addTemporalMarker(1, () -> {
                    clawRightServo.setPosition(0.75);
                    clawLeftServo.setPosition(0.25);
                    moveWrist(-10,1);
                    moveViperslides(1150, 0.5);
                })
